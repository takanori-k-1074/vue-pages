<template>
  <div class="container">
    ...
    <form class="col">
      ...
      <div class="row">
        <div class="input-field">
          <input placeholder="Artist" type="text" class="validate" v-model="music.artist" required="required">
        </div>
      </div>
      <div class="row">
        <div class="input-field">
  ...
  export default {
    ...
    methods: {
      createMusic: function () {
        ...
        axios.post('https://mysteamnews1074.com/api/v1/music', { music: this.music }).then(() => {
